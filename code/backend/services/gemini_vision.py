...
Respond ONLY with valid JSON."""
    ...
    def _fallback_face(self, image_bytes: bytes) -> dict:
        return self._get_fallback().analyze_image_fallback(image_bytes, "face")

    def _fallback_body(self, image_bytes: bytes) -> dict:
        return self._get_fallback().analyze_image_fallback(image_bytes, "body")

    def _fallback_skin(self, image_bytes: bytes) -> dict:
        return self._get_fallback().analyze_image_fallback(image_bytes, "skin")

    def _fallback_hair(self, image_bytes: bytes) -> dict:
        return self._get_fallback().analyze_image_fallback(image_bytes, "hair")
